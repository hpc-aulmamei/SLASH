...
static int test_ctrl_offsets(void)
{
    ...
    CHECK_EQ32(offsetof(rp1_ctrl_t, capabilities),     0x64, "ctrl.capabilities offset");
    CHECK_EQ32(offsetof(rp1_ctrl_t, pdi_ipi_platform_id),
               0x68, "ctrl.pdi_ipi_platform_id offset");
    CHECK_EQ32(offsetof(rp1_ctrl_t, terminal_error_node),
               0x6C, "ctrl.terminal_error_node offset");
    CHECK_EQ32(offsetof(rp1_ctrl_t, terminal_error_detail),
    ...
    CHECK_EQ32(offsetof(rp1_inflight_t, timeout_cycles),
               0x10, "inflight.timeout_cycles offset");
    return 0;
}
