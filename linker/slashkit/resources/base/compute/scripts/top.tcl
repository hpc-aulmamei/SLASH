...
# zero hash with bit [28] set, which still identifies this as the compute shell.
if { ![info exists ::build_id_lo] } { set ::build_id_lo 0 }
if { ![info exists ::build_id_hi] } { set ::build_id_hi 0x10000000 }
...
proc create_hier_cell_clk_rst_shell { parentCell nameHier } {
  ...
  # Bits [27:0] = next 28 bits of the git SHA-1; bit [28] = shell type (1 = compute);
...
24.000 HBM_PC1_SCRUB_START_ADDRESS 0x0000000 HBM_PC1_SCRUB_END_ADDRESS 0x3FFFBFF HBM_PC1_SCRUB_INTERVAL 24.000} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M02_INI {read_bw {800} write_bw {800} read_avg_burst {64} write_avg_burst {64} initial_boot {false}} M04_INI {read_bw {500} write_bw {500} initial_boot {true}} M00_INI {read_bw {800} write_bw {800} read_avg_burst {64} write_avg_burst {64} initial_boot {false}}} \
   CONFIG.DEST_IDS {} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {ps_pmc} \
