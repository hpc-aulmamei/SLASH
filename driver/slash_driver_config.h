 ...
 * 02110-1301, USA.
 */
#ifndef SLASH_DRIVER_CONFIG_H
#define SLASH_DRIVER_CONFIG_H
...
#define SLASH_DRIVER_NAME "slash"
...
#undef pr_fmt
#define pr_fmt(fmt) "%s:%s: " fmt, SLASH_DRIVER_NAME, __func__

#endif /* SLASH_DRIVER_CONFIG_H */
